...
public class MVVMMarqueTextView extends View {
    ...
    public MVVMMarqueTextView(Context context) {
        super(context);
        init(null);
    }

    public MVVMMarqueTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MVVMMarqueTextView(Context context, AttributeSet attrs, int defStyleAttr) {
